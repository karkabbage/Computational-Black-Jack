...
my_message = Message(instructions_label, text="In BlackJack there are a lot of different influences that come together "
...
def something_to_cover() -> None:
    ...
    something_to_cover3 = Label(blackjack, text="                                                                   "
                                                "                                                                  "
                                                "                                              ")
    ...
    something_to_cover5 = Label(blackjack, text="                                                                   "
                                                "                                                       "
                                                "                                               ")
...
def get_necessary_inputs() -> None:
    """Depending on the type of tree the person using the function choose return entries that they have to add in."""
